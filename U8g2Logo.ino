...
U8G2_KS0108_128X64_1 u8g2(U8G2_R0, 8, 9, 10, 11, 4, 5, 6, 7, /*enable=*/ 16, /*dc=*/ 17, /*cs0=*/ 14, /*cs1=*/ 15, /*cs2=*/ U8X8_PIN_NONE, /* reset=*/  21); 	// Set R/W to low!
...
{
    u8g2.setFont(u8g2_font_inb16_mf);
    //u8g2.drawStr(1,20,"Temperature:");
    u8g2.setCursor(1, 20);
    u8g2.print( temp, 1);
    //u8g2.drawStr(1,40,"Humidity:");
    u8g2.setCursor(1, 40);
    u8g2.print( humd, 1);
}
